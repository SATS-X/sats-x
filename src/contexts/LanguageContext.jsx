...
const translations = {
    vi: {
        ...
        addStudentToSubject: 'Thêm học sinh vào môn học',
        availableStudents: 'Học sinh khả dụng',
        studentDetails: 'Thông tin học sinh',
        selectStudentToView: 'Chọn học sinh để xem thông tin',
        pleaseSelectStudent: 'Vui lòng chọn học sinh',
        studentAddedSuccessfully: 'Đã thêm học sinh vào môn học thành công',
        failedToAddStudent: 'Không thể thêm học sinh vào môn học',
        failedToLoadStudents: 'Không thể tải danh sách học sinh',
        email: 'Email',
        phone: 'Điện thoại',
        close: 'Đóng',
        saving: 'Đang lưu...',
        ...
        selectClassFirst: 'Vui lòng chọn lớp học trước',
        noAvailableStudents: 'Không có học sinh khả dụng trong lớp này',
        removeStudent: 'Xóa học sinh',
        remove: 'Xóa',
        removing: 'Đang xóa...',
        removeStudentConfirmMessage: 'Bạn có chắc chắn muốn xóa học sinh này khỏi môn học?',
        removeStudentWarning: 'Hành động này sẽ xóa học sinh khỏi môn học. Học sinh có thể được thêm lại sau nếu cần.',
        studentRemovedSuccessfully: 'Đã xóa học sinh khỏi môn học thành công',
        failedToRemoveStudent: 'Không thể xóa học sinh khỏi môn học',
        availableStudentsCount: 'học sinh khả dụng',
        ...
        // Face Management
        faceManagement: 'Quản lý khuôn mặt',
        faceManagementDesc: 'Quản lý ảnh khuôn mặt của học sinh theo lớp',
        manageFacesByClass: 'Quản lý ảnh khuôn mặt của học sinh theo lớp',
        faceManagementReady: 'Sẵn sàng',
        classList: 'Danh sách lớp học',
        selectClassToManage: 'Chọn lớp để quản lý khuôn mặt học sinh',
        noClassesInSystem: 'Chưa có lớp học nào trong hệ thống.',
        manageFaces: 'Quản lý khuôn mặt',
        loadingClasses: 'Đang tải danh sách lớp học...',
        errorLoadingClasses: 'Lỗi khi tải danh sách lớp học',
        loadingStudentList: 'Đang tải danh sách học sinh...',
        displayingStudents: 'Đang hiển thị',
        viewFaces: 'Xem khuôn mặt',
        faceImagesList: 'Danh sách ảnh khuôn mặt',
        addImage: 'Thêm ảnh',
        loadingImages: 'Đang tải ảnh...',
        noFaceImages: 'Chưa có ảnh khuôn mặt',
        noFaceImagesDesc: 'Học sinh này chưa có ảnh khuôn mặt nào được lưu trong hệ thống.',
        addFirstImage: 'Thêm ảnh đầu tiên',
        viewImage: 'Xem',
        deleteImage: 'Xóa',
        confirmDeleteImage: 'Bạn có chắc chắn muốn xóa ảnh này?',
        imageDeletedSuccess: 'Đã xóa ảnh thành công',
        cannotDeleteImage: 'Không thể xóa ảnh',
        errorDeletingImage: 'Lỗi khi xóa ảnh',
        cannotLoadImage: 'Không thể tải ảnh',
        uploadFeatureComingSoon: 'Tính năng upload ảnh sẽ được triển khai sau',
        cannotLoadFaceList: 'Không thể tải danh sách ảnh khuôn mặt',
        websocketConnectionError: 'Lỗi kết nối WebSocket',
        ...
        selectClassOption: 'Chọn lớp học',
        uploadFaceImage: 'Tải ảnh khuôn mặt',
        clickToUploadFaceImage: 'Nhấn để tải ảnh khuôn mặt',
        clickToChangeImage: 'Nhấn để thay đổi ảnh',
        supportedFormats: 'Định dạng hỗ trợ: JPG, PNG, JPEG',
        maxFileSize: 'Kích thước tối đa: 5MB',
        uploading: 'Đang tải lên...',
        invalidImageFormat: 'Định dạng ảnh không hợp lệ',
        imageTooLarge: 'Kích thước ảnh quá lớn (tối đa 5MB)',
        faceAddedSuccess: 'Thêm khuôn mặt thành công',
        cannotAddFace: 'Không thể thêm khuôn mặt',
        errorAddingFace: 'Lỗi khi thêm khuôn mặt',
        uploadTimeout: 'Quá thời gian tải lên',
        backToClassList: 'Quay lại danh sách lớp',
        image: 'Hình ảnh',
        addFaceImage: 'Thêm ảnh khuôn mặt',
        updateFaceImage: 'Cập nhật ảnh',
        totalFaceImages: 'Tổng ảnh khuôn mặt',
        faceImagesCount: 'ảnh',
        manageStudentsSection: 'Quản lý sinh viên',
        addNewStudent: 'Thêm sinh viên mới',
        studentAddedSuccess: 'Đã thêm sinh viên thành công',
        errorAddingStudent: 'Lỗi khi thêm sinh viên',
        invalidEmailFormat: 'Định dạng email không hợp lệ',
        invalidPhoneFormat: 'Số điện thoại phải có 10-11 chữ số',
        adding: 'Đang thêm...',
        birthday: 'Ngày sinh',
        studentIdExists: 'Mã sinh viên đã tồn tại',
        invalidStudentData: 'Dữ liệu sinh viên không hợp lệ',
        deleteStudent: 'Xóa sinh viên',
        deleteStudentConfirmMessage: 'Bạn có chắc chắn muốn xóa sinh viên này không?',
        deleteStudentWarning: 'Tất cả dữ liệu liên quan đến sinh viên này sẽ bị xóa vĩnh viễn. Hành động này không thể hoàn tác.',
        studentDeletedSuccess: 'Đã xóa sinh viên thành công',
        errorDeletingStudent: 'Lỗi khi xóa sinh viên',
        studentNotFound: 'Không tìm thấy sinh viên',
        deleting: 'Đang xóa...',
        warning: 'Cảnh báo',
        confirmAction: 'Vui lòng xác nhận hành động của bạn.',
        deleteFaceID: 'Xóa Face ID',
        moreActions: 'Thêm hành động',
        faceNotFound: 'Không tìm thấy Face ID',
        faceDeletedSuccess: 'Đã xóa Face ID thành công',
        errorDeletingFace: 'Lỗi khi xóa Face ID',
        cannotDeleteFace: 'Không thể xóa Face ID',
        deleteFaceConfirmMessage: 'Bạn có chắc chắn muốn xóa Face ID này không?',
        deleteFaceWarning: 'Dữ liệu khuôn mặt sẽ bị xóa khỏi hệ thống. Sinh viên sẽ không thể điểm danh bằng khuôn mặt cho đến khi thêm lại.',
        deleteTimeout: 'Quá thời gian xóa',
        currentFaceImage: 'Ảnh khuôn mặt hiện tại',
        studentHasFaceID: 'Sinh viên đã có Face ID',
        uploadNewImageToUpdate: 'Tải lên ảnh mới để cập nhật khuôn mặt',
        loadingCurrentImage: 'Đang tải ảnh hiện tại...',
        noCurrentImage: 'Không có ảnh hiện tại'
    },
